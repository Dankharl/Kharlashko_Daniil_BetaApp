...
//    @State private var loginErrorMessage: String = "" // Error message for validation
//
//    var body: some View {
//        ZStack {
...
//                    .padding(.bottom, 20)
//
//                // Sign Up - Username field (only for Sign Up)
//                if isSignUp {
...
//                    if isSignUp {
//                        // Sign up the user
//                        if password == confirmPassword && password.count >= 3 && username.count >= 3 {
...
//                            // Success
//                            loginErrorMessage = ""  // Clear error message
//                        } else {
//                            // Show login error
